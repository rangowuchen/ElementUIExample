<!--
 * @Author: wuchen
 * @Date: 2021-12-16 09:57:24
 * @LastEditors: wuchen
 * @LastEditTime: 2021-12-16 15:20:03
 * @Description: https://juejin.cn/post/7000652451435003918
    ...
    <div>
        <div class="waterButton">
            <div class="good">
                ...
                <span :class="{'good_water-1':btnClick}"></span>
                <span :class="{'good_water-2':btnClick}"></span>
            </div>
        </div>
    </div>
</template>
