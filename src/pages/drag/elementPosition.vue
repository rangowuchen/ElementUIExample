 ...
 * @LastEditors: wuchen
 * @LastEditTime: 2022-09-30 13:58:58
 * @Description: 
...
<template>
    <div class="contain" ref="contain">
        ...
        <div @mousedown="mousedownL" :style="{width: '4px',height:'24px',background:getColor(currentX1),position:'absolute',left:currentX1+'px',top:'-2px',cursor:'col-resize',zIndex:'99',borderRadius:'2px'}"></div>
        <div @mousedown="mousedownR" :style="{width: '4px',height:'24px',background:getColor(currentX2),position:'absolute',left:currentX2+'px',top:'-2px',cursor:'col-resize',zIndex:'99',borderRadius:'2px'}"></div>
...
export default {
    data() {
        return {
            ...
            currentX2: 200,// 右侧滑块起始位置
            containWidth: 200,// 容器的宽度
        }
    },
    methods: {
        getColor(current) {
        ...
        mousedownL(e) {
            ...
            document.onmousemove = function(e2) {
                ...
                let bb = e2.clientX - aa;
                if(bb < 0) {
                    _that.currentX1 = 0;
                }else if(bb > _that.containWidth) {
