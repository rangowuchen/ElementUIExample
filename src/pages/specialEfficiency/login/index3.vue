<!--
 * @Author: wuchen
 * @Date: 2020-07-24 18:55:07
 * @LastEditors: wuchen
 * @LastEditTime: 2020-07-24 19:21:10
 * @Description: 
            ...
            <form class="form">
                ...
                <div class="form__content">
                    ...
                    <div class="styled-input">
                        <input type="text" class="styled-input__input" placeholder="请输入用户名" name="nickname">
                        <div class="styled-input__placeholder"> <span class="styled-input__placeholder-text"></span> </div>
                        <div class="styled-input__circle"></div>
                    </div>
                    <div class="styled-input">
                        <input type="text" class="styled-input__input" placeholder="请输入密码">
                        <div class="styled-input__placeholder"> <span class="styled-input__placeholder-text"></span> </div>
                        <div class="styled-input__circle"></div>
                    </div>
                    <button type="button" class="styled-button"> <span class="styled-button__real-text-holder"> <span class="styled-button__real-text">确定</span> <span class="styled-button__moving-block face"> <span class="styled-button__text-holder"> <span class="styled-button__text">确定</span> </span> </span><span class="styled-button__moving-block back"> <span class="styled-button__text-holder"> <span class="styled-button__text">确定</span> </span> </span> </span> </button>
                </div>
            </form>
        </main>
    </div>
            ...
            init() {
                ...
                inputs.forEach(function(el) {
                    ...
                    el.addEventListener('focus', function() {
                        ...
                        that.placeholderAnimationIn(parent, true);
                    }, false);
                    el.addEventListener('blur', function() {
                        if (el.value.length) return;
                        parent.classList.remove('filled');
                        that.placeholderAnimationIn(parent, false);
                    }, false);
                });
            },
