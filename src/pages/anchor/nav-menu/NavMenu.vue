<!--
 * @Author: wuchen
 * @Date: 2020-07-01 10:01:58
 * @LastEditors: wuchen
 * @LastEditTime: 2020-07-01 10:12:20
 * @Description: 
...
<template>
  <div>
    ...
    >
      <!-- 页面(中/英文显示) -->
      <el-menu-item index="1">{{'pages.page1'}}</el-menu-item>
      <el-menu-item index="2">{{'pages.page2'}}</el-menu-item>
      <el-menu-item index="3">{{'pages.page3'}}</el-menu-item>
      <el-menu-item index="4">{{'pages.page4'}}</el-menu-item>
