...
<script>
import NavMenu from "./nav-menu/NavMenu.vue"; //导航栏组件
import PageOne from "./page-1/PageOne"; //第一页
import PageTwo from "./page-2/PageTwo"; //第二页
import PageThree from "./page-3/PageThree"; //第三页
import PageFour from "./page-4/PageFour"; //第四页
